...
# Load the dataset
file_path = "Plotting_Model/Annual_Model_Measurements/PM25.annual.ON.nc4"
...
model = model.rename(columns={'PM25':'Air Pollution Level'})
# Display the full data in table form (save to CSV if needed)
model.to_csv("pm25_data.csv", index=False)
...
plt.ylabel("Latitude")
plt.title("Percent difference between model and measurements for PM2.5")
plt.grid(True)
plt.show()
...
map_path = "Model_Validation/Map_Representation/PM25_Europe_Map.html"
