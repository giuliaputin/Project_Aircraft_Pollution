...
plt.scatter(df["Longitude"], df["Air Pollution Level"], alpha=0.5, c=df["Air Pollution Level"], cmap="Blues")
plt.colorbar(label="O3 Concentration (µg/m³)")
plt.xlabel("Longitude")
plt.ylabel("O3 Concentration (µg/m³)")
plt.title("O3 Concentration Across Europe")
plt.grid(True)
plt.show()
...
map_path = "Plotting_Measurements/Map_Representation/O3_Europe_Map.html"
