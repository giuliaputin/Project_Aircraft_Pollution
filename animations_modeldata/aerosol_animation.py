...
# Saving of the files
if average:
    ani.save(os.path.join(os.path.dirname(__file__),"..",'animations_modeldata', 'animations', f'{month}_{aviation}_{var}_avg.mp4'), writer='ffmpeg', fps=4)
else:
    ani.save(os.path.join(os.path.dirname(__file__),"..", 'animations_modeldata', 'animations', f'{month}_{aviation}_{var}_lev{level}.mp4'), writer='ffmpeg', fps=4)
